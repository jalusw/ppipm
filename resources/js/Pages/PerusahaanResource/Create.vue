...
const createPerusahaanFormSubmitHandler = () => {
    router.post(route("management.perusahaans.store"), createPerusahaanForm);
};
...
<template>
    <Head title="Entry Data Perusahaan" />
    <AdminLayout>
        <h1 class="font-bold text-xl text-primary">Entry Data Perusahaan</h1>
